...
public class AStarPathFinder implements PathFinder, Serializable {
	 ...
	 * @param maxComplicity the max complicity
	 * @param allowDiagMovement True if the search should try diaganol movement
	 */
	public AStarPathFinder(Pathfindable map, int maxSearchDistance,
			int maxComplicity, boolean allowDiagMovement) {
	 ...
	 */
	protected boolean isValidLocation(Mover mover, int sx, int sy, int x,
